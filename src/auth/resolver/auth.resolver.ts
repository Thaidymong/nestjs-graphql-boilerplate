...
import { LoginResponse, RefreshTokenResponse } from "../dto/response/login.response";
import { LoginDto } from "../dto/input/login.input";
import { Public } from "../decorators/public.decorator";
import { CreateUserResponse } from "src/user/dto/response";
...
export class AuthResolver {
    ...
    async me(@CurrentUser() user: CreateUserResponse) {
        return user;
    }
}
